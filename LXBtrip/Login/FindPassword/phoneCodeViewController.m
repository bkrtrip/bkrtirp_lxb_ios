...
@property (strong,nonatomic)ResetPasswordViewController *resetPwVC;
@end
...
-(void)registerClick:(UIButton *)item{
    if (!self.resetPwVC) {
        ...
        self.resetPwVC = [sb instantiateViewControllerWithIdentifier:@"resetPwVC"];

    }
        [self.navigationController pushViewController:self.resetPwVC animated:YES];
}
