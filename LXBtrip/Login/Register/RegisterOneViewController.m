...
@property(weak, nonatomic)RegisterTowViewController *rTowVC;
@end
...
#pragma mark 点击下一步跳到下一界面
-(void)registerClick:(UIButton *)item{
//    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
//    RegisterTowViewController *rTowVC = [sb instantiateViewControllerWithIdentifier:@"rTowVC"];
    if (!self.rTowVC) {
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
         self.rTowVC = [sb instantiateViewControllerWithIdentifier:@"rTowVC"];
    }
    [self.navigationController pushViewController:self.rTowVC animated:YES];
}
