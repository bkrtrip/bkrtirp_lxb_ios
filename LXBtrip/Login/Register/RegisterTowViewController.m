...
@property(strong,nonatomic)RegisterThreeViewController *rThreeVC;
@end
...
#pragma mark 点击下一步，跳到下一界面
-(void)registerClick:(UIButton *)item{
    if (!self.rThreeVC) {
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
         self.rThreeVC = [sb instantiateViewControllerWithIdentifier:@"rThreeVC"];
    }
    [self.navigationController pushViewController:self.rThreeVC animated:YES];
}
#pragma mark 点击返回回到上一界面
