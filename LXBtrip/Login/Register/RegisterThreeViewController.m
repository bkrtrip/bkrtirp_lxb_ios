...
-(void)buildUI{
    ...
    [registerItem setTitle:@"完成" forState:UIControlStateNormal];//设置按钮文字
    ...
    registerItem.frame = CGRectMake(0, 0, 30, 44); ;
    [registerItem addTarget:self action:@selector(registerClick:)
           forControlEvents:UIControlEventTouchUpInside];//这个方法等下一个界面搭建了实现
