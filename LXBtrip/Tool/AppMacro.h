...
#define SWITCH_CITY_SUPPLIER_SEARCH_RESULTS @"SWITCH_CITY_SUPPLIER_SEARCH_RESULTS"
...
#define LIST_HOR_SPACING_MICROSHOP 5.f
...
#define LIST_HOR_SPACING_SUPPLIER 5.f
...
#define LIST_HOR_SPACING_SIFT_SUPPLIER 5.f
...
#define MAX_IDENTITY_NUMBER_LENGTH 18
