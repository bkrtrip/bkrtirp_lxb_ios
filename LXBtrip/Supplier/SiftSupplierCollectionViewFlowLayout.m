...
- (id)init
{
    self = [super init];
    if (self) {
        CGFloat itemWidth = (SCREEN_WIDTH-LIST_HOR_MARGIN_SIFT_SUPPLIER*2-(NUM_OF_IMAGES_PER_ROW_SIFT_SUPPLIER-1)*LIST_HOR_SPACING_SIFT_SUPPLIER)/NUM_OF_IMAGES_PER_ROW_SIFT_SUPPLIER;
