...
@property (nonatomic, copy) NSNumber *marketAdultPrice;//成人价
@property (nonatomic, copy) NSNumber *marketAdultPerson;//成人人数

@property (nonatomic, copy) NSNumber *marketKidPrice;//儿童占床价
@property (nonatomic, copy) NSNumber *marketKidPriceNoBed;//儿童不占床价
@property (nonatomic, copy) NSNumber *marketKidPerson;//儿童人数

@property (nonatomic, copy) NSNumber *marketDiffPrice;//单房差
